        ...
        <div className="relative mx-auto max-w-6xl py-24">
          ...
          <div className="text-center">
            <h1 className="text-4xl font-bold tracking-tight text-white sm:text-6xl">
                We make polyp detections easier, faster and more accurate!
            </h1>
            ...
            <div className="mt-10 flex items-center justify-center gap-x-2">
              ...
              <button
                type="button"
                className="rounded-md border hover:bg-white hover:text-slate-700 transition duration-300 ease-in-out hover:scale-105 active:scale-95 border-white px-3 py-2 text-sm font-semibold text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
              >
                Get Started
              </button>
            </div>
